                ...
                foreach ($query->result() as $row) {
      			...
      			<h4 align="center"><?php  echo $this->session->userdata('userlogado')->nome;?>, você faz parte da República <?php  echo $nome_rep;?></h4>
      				<center>
	      				...
	      				<button type="button" class="btn custombtn" data-toggle="modal" data-target="#myModal">Excluir conta</button>
      				</center>
					    ...
					    <div class="modal-dialog">
					      ...
					      <div class="modal-content">
					        ...
					        <div class="modal-footer">
					          <button type="button" class="btn custombutton" data-dismiss="modal">Não</button>
					        </div>
					        <div class="modal-footer">
